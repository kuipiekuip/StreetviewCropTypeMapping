    ...
    for element in road_data['elements']:
        if 'geometry' in element:
            for node in element['geometry']:
                ...
                distance = geodesic(tree_point, road_point).meters  # Calculate distance in meters
...
def process_road_data(road_data, geo_idx, geo_data):
    ...
    nearest_road_point, bearing = find_nearest_road_point_and_compute_bearing(tree_lat, tree_lon, road_data)
