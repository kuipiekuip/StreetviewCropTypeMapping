...
# LANDCOVER_FILENAME = r'C:\Users\kuipe\OneDrive\Bureaublad\TU Delft\Master\Deep Learning\Project\StreetviewCropTypeMapping\data\OverlappedLandCoverRoadsThailandESA-WorldCover-sides20x20.csv'
...
imLimit = 100
getMeta(trees, 'images', imLimit=1000)